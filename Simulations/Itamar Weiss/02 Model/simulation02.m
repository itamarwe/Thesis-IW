...
N = 2^12; %Number of samples used for estimation
L = 5; %Number of receivers
...
rTransmitter = [100 200]; %Transmitter position [x,y] [m]
v = [300/sqrt(2) 300/sqrt(2)];%Transmitter velocity [vx, vy] [m/s]

Fc = 1e010; % Carrier Frequency[Hz]
...
gridX = [randn(1,TRIALS-1)*1000 0];
gridY = [randn(1,TRIALS-1)*1000 0];
