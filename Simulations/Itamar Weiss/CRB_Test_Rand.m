...
receiverGeometry = 2; %1-circular with radius R 2- Linear with length 2R

rReceiverMat = LocateReceivers(R,L,receiverGeometry); %The locations of the receivers

maxGridSampleDelay = ceil(4*R*(Fs/C)); %The maximum possible delay
...
grid on;
legend('CRB X RMS', 'CRB Y RMS', 'CRB Vx RMS', 'CRB Vy RMS');
title 'CRB Vs. SNR';
sqrt(CRBX(1))
sqrt(CRBVx(1))
